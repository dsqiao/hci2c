    ...
    <div style={{ display: 'flex', flexDirection: 'row', padding: '0 200px 100px 200px', gap: '50px' }}>
      ...
      <div style={{ flexGrow: 1 }}>
        ...
        }
        {
          currentStep === '4' &&
          <div>
            <p className="feedback-p">1. 您会在未来使用/购买该产品吗？为什么？</p>
            <Table columns={columns} dataSource={[]} />
            <p className="feedback-p">2. 您将可能会在什么情况下使用该产品？您认为该产品的使用目的是什么？</p>
            <Table columns={columns} dataSource={[]} />
            <p className="feedback-p">3. 您认为该产品最好的方面是什么？为什么？</p>
            <Table columns={columns} dataSource={[]} />
            <p className="feedback-p">4. 如果您在操作过程中还存在其他任何问题，请告诉我们：</p>
            <Table columns={columns} dataSource={[]} />
          </div>
        }
        {
          ...
          <div>
            ...
            <div id="res"></div>
            <p>从用户感受方面看，易用性维度的评价得分为 67.5 分，有效性维度的平均得分为 57.9 分，易学性维度的评价得分为 67.2 分，满意度维度的平均得分为64.2 分。</p>
            <p>从产品质量方面看，系统质量维度的平均得分为 56.7 分，信息质量维度的平均得分为 62.3 分，界面质量维度的平均得分为 65.6 分。</p>
            <p>对于本量表，平均值的参考值为 60 分。</p>
            <p>这说明，测试用户在 易用性、易学性和界面质量等维度上认可您的产品，但认为您的产品在有效性和系统质量上存在不足。</p>
            <Button>下一页</Button>
          </div>
        }
      </div>
